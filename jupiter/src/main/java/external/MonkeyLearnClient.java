...
public class MonkeyLearnClient {
	...
	private static final String API_KEY ="497069d5de2bc1a8de8236b9829b527278dc16ed";
	
	public static void main(String[] args) {
		
		String[] textList = {
				"Software engineer in Frontend development React Redux",
				"Software engineer in Android development RxJava Firebas", 
